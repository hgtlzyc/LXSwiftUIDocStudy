...
actor BirdBrain {
    ...
    /// make sure `createSharedInstance` called before access `shared` instance
...
// MARK: - Handle Unfinished Payemnts
extension BirdBrain {
...
// MARK: - Payment Process Helpers
private extension BirdBrain {
...
// MARK: - Product Process Helpers
private extension BirdBrain {
    func birdFood(for productID: Product.ID) -> (BirdFood, BirdFood.Product)? {
